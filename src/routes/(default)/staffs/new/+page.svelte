  ...
  <form onsubmit={() => confirm = true} class="h-full flex-1 w-0 flex flex-col gap-3 rounded-2xl">
        <Heading tag="h1" class="font-bold  md:text-xl lg:text-xl text-white">New Staff Form</Heading>
            ...
            <ButtonGroup class="w-full">
                ...
                <Input id="new-staff-username" placeholder="SintiAKT" bind:value={newStaff.username}/>
            </ButtonGroup>
            ...
            <ButtonGroup class="w-full">
                ...
                <Input id="new-staff-fullname" placeholder="Sinti Putri Sele" bind:value={newStaff.fullname}/>
            </ButtonGroup>
            ...
            <ButtonGroup class="w-full">
                ...
                <Input id="new-staff-username" type="password" bind:value={newStaff.password}/>
            </ButtonGroup>
        ...
        {#if confirm}
            <Modal title="New Staff Confirmation" form bind:open={confirm} headerClass="pb-0!" bodyClass="pt-0!">
                ...
                {:else if success}
                    <UserAddOutline/> Success, try to logon.
